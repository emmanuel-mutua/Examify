...
public class StudentEditMarksModel {
    String studentUid;
    String unitCode;
    String studentName;
    ...
    public StudentEditMarksModel(String studentUid, String unitCode,String studentName, String registrationNumber, Integer unitAssign1Marks, Integer unitAssign2Marks, Integer unitCat1Marks, Integer unitCat2Marks, Integer unitExamMarks) {
